  ...
  return (
    <Box
      ...
      sx={{
        ...
        background: "radial-gradient(ellipse 80% 100% at 50% 0%, rgba(137,87,229,0.07), transparent 70%)",
      }}
    >
      <Container>
        <Reveal sx={{ textAlign: "center", mb: { xs: 5, md: 8 } }}>
          ...
          <Typography variant="body1" sx={{ color: "text.secondary", mt: 2, maxWidth: 620, mx: "auto", fontSize: { md: 18 } }}>
              ...
              >
                <TiltCard
                  sx={{
                    ...
                    "&:hover": { borderColor: "rgba(163,113,247,0.5)", boxShadow: "0 18px 40px -22px rgba(137,87,229,0.6)" },
                  }}
                >
